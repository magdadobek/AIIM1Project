    ...
    <div class="bg-light_component dark:bg-dark_component text-light_menu dark:text-white justify-center p-6 rounded-3xl m-5 w-min shadow-lg">
      <form method="post" class="flex flex-col justify-center items-center" onSubmit={handleSubmit}>
        ...
        <div class="flex justify-between py-2 w-64">
          ...
          <a href="/rejestracja"class="text-light_menu border-light_menu border-2 hover:border-dark_yellow_umg hover:text-dark_yellow_umg dark:border-dark_field dark:text-dark_field dark:hover:border-dark_yellow_umg dark:hover:text-dark_yellow_umg font-bold p-2 rounded-3xl text-base my-5 px-3 py-1 shadow-md ">
            Zarejestruj się
          </a>
        </div>
      </form>
