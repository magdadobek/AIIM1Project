...
const QuestionBoard = () => {
    ...
    useEffect(() => {
        const fetchQuestions = async () => {
            const response = await fetch('http://localhost:8000/api/qna/allOpen', {
                method: 'GET',
                headers: {
    ...
    return (
        <div className="w-[800px]">
            <div className="flex justify-between items-center">
                ...
                <p className="text-3xl font-bold m-4 text-center dark:text-dark_yellow_umg">Tablica pytań</p>
