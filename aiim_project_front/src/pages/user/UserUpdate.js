...
export const UserUpdate = () => {
    ...
    useEffect(() => {
        const fetchUser = async () => {
            const response = await fetch('https://foka.umg.edu.pl/~projgr2324md/AIIM1Project/aiim_project/public/api/user/find/' + params.userId + '?' + new URLSearchParams({
    ...
    const handleSubmit = async () => {
        ...
        const response = await fetch("https://foka.umg.edu.pl/~projgr2324md/AIIM1Project/aiim_project/public/api/user/update/all/" + params.userId, {
            method: 'PATCH',
            headers: {
                "Content-Type": "application/json",
                "Accept": "application/json",
